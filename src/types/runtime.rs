...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\rruntime.proto\x12\x1fk8s.io.apimachinery.pkg.runtime\"\x20\n\x0cRawE\
    xtension\x12\x10\n\x03raw\x18\x01\x20\x01(\x0cR\x03raw\">\n\x08TypeMeta\
    \x12\x1e\n\napiVersion\x18\x01\x20\x01(\tR\napiVersion\x12\x12\n\x04kind\
    \x18\x02\x20\x01(\tR\x04kind\"\xae\x01\n\x07Unknown\x12E\n\x08typeMeta\
    \x18\x01\x20\x01(\x0b2).k8s.io.apimachinery.pkg.runtime.TypeMetaR\x08typ\
    eMeta\x12\x10\n\x03raw\x18\x02\x20\x01(\x0cR\x03raw\x12(\n\x0fcontentEnc\
    oding\x18\x03\x20\x01(\tR\x0fcontentEncoding\x12\x20\n\x0bcontentType\
    \x18\x04\x20\x01(\tR\x0bcontentTypeB\tZ\x07runtimeJ\x96\"\n\x06\x12\x04\
    \x13\0}\x01\n\x82\x05\n\x01\x0c\x12\x03\x13\0\x122\xac\x04\nCopyright\
    \x20The\x20Kubernetes\x20Authors.\n\nLicensed\x20under\x20the\x20Apache\
    ...
    \x20This\x20file\x20was\x20autogenerated\x20by\x20go-to-protobuf.\x20Do\
    \x20not\x20edit\x20it\x20manually!\n\n\x08\n\x01\x02\x12\x03\x15\x08'\n\
    \x08\n\x01\x08\x12\x03\x18\0\x1e\nA\n\x04\x08\xe7\x07\0\x12\x03\x18\0\
    \x1e\x1a4\x20Package-wide\x20variables\x20from\x20generator\x20\"generat\
    ed\".\n\n\x0c\n\x05\x08\xe7\x07\0\x02\x12\x03\x18\x07\x11\n\r\n\x06\x08\
    \xe7\x07\0\x02\0\x12\x03\x18\x07\x11\n\x0e\n\x07\x08\xe7\x07\0\x02\0\x01\
    \x12\x03\x18\x07\x11\n\x0c\n\x05\x08\xe7\x07\0\x07\x12\x03\x18\x14\x1d\n\
    \xab\x0b\n\x02\x04\0\x12\x04G\0L\x01\x1a\x9e\x0b\x20RawExtension\x20is\
    \x20used\x20to\x20hold\x20extensions\x20in\x20external\x20versions.\n\n\
    \x20To\x20use\x20this,\x20make\x20a\x20field\x20which\x20has\x20RawExten\
    sion\x20as\x20its\x20type\x20in\x20your\x20external,\x20versioned\n\x20s\
    truct,\x20and\x20Object\x20in\x20your\x20internal\x20struct.\x20You\x20a\
    lso\x20need\x20to\x20register\x20your\n\x20various\x20plugin\x20types.\n\
    \n\x20//\x20Internal\x20package:\n\x20type\x20MyAPIObject\x20struct\x20{\
    \n\x20\truntime.TypeMeta\x20`json:\",inline\"`\n\x20\tMyPlugin\x20runtim\
    e.Object\x20`json:\"myPlugin\"`\n\x20}\n\x20type\x20PluginA\x20struct\
    \x20{\n\x20\tAOption\x20string\x20`json:\"aOption\"`\n\x20}\n\n\x20//\
    \x20External\x20package:\n\x20type\x20MyAPIObject\x20struct\x20{\n\x20\t\
    runtime.TypeMeta\x20`json:\",inline\"`\n\x20\tMyPlugin\x20runtime.RawExt\
    ension\x20`json:\"myPlugin\"`\n\x20}\n\x20type\x20PluginA\x20struct\x20{\
    \n\x20\tAOption\x20string\x20`json:\"aOption\"`\n\x20}\n\n\x20//\x20On\
    \x20the\x20wire,\x20the\x20JSON\x20will\x20look\x20something\x20like\x20\
    this:\n\x20{\n\x20\t\"kind\":\"MyAPIObject\",\n\x20\t\"apiVersion\":\"v1\
    \",\n\x20\t\"myPlugin\":\x20{\n\x20\t\t\"kind\":\"PluginA\",\n\x20\t\t\"\
    aOption\":\"foo\",\n\x20\t},\n\x20}\n\n\x20So\x20what\x20happens?\x20Dec\
    ode\x20first\x20uses\x20json\x20or\x20yaml\x20to\x20unmarshal\x20the\x20\
    serialized\x20data\x20into\n\x20your\x20external\x20MyAPIObject.\x20That\
    \x20causes\x20the\x20raw\x20JSON\x20to\x20be\x20stored,\x20but\x20not\
    \x20unpacked.\n\x20The\x20next\x20step\x20is\x20to\x20copy\x20(using\x20\
    pkg/conversion)\x20into\x20the\x20internal\x20struct.\x20The\x20runtime\
    \n\x20package's\x20DefaultScheme\x20has\x20conversion\x20functions\x20in\
    stalled\x20which\x20will\x20unpack\x20the\n\x20JSON\x20stored\x20in\x20R\
    awExtension,\x20turning\x20it\x20into\x20the\x20correct\x20object\x20typ\
    e,\x20and\x20storing\x20it\n\x20in\x20the\x20Object.\x20(TODO:\x20In\x20\
    the\x20case\x20where\x20the\x20object\x20is\x20of\x20an\x20unknown\x20ty\
    pe,\x20a\n\x20runtime.Unknown\x20object\x20will\x20be\x20created\x20and\
    \x20stored.)\n\n\x20+k8s:deepcopy-gen=true\n\x20+protobuf=true\n\x20+k8s\
    :openapi-gen=true\n\n\n\n\x03\x04\0\x01\x12\x03G\x08\x14\n\x92\x01\n\x04\
    \x04\0\x02\0\x12\x03K\x02\x19\x1a\x84\x01\x20Raw\x20is\x20the\x20underly\
    ing\x20serialization\x20of\x20this\x20object.\n\n\x20TODO:\x20Determine\
    \x20how\x20to\x20detect\x20ContentType\x20and\x20ContentEncoding\x20of\
    \x20'Raw'\x20data.\n\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03K\x02\n\n\x0c\n\
    \x05\x04\0\x02\0\x05\x12\x03K\x0b\x10\n\x0c\n\x05\x04\0\x02\0\x01\x12\
    \x03K\x11\x14\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03K\x17\x18\n\xc5\x04\n\
    \x02\x04\x01\x12\x04\\\0b\x01\x1a\xb8\x04\x20TypeMeta\x20is\x20shared\
    \x20by\x20all\x20top\x20level\x20objects.\x20The\x20proper\x20way\x20to\
    \x20use\x20it\x20is\x20to\x20inline\x20it\x20in\x20your\x20type,\n\x20li\
    ke\x20this:\n\x20type\x20MyAwesomeAPIObject\x20struct\x20{\n\x20\x20\x20\
    \x20\x20\x20runtime.TypeMeta\x20\x20\x20\x20`json:\",inline\"`\n\x20\x20\
    \x20\x20\x20\x20...\x20//\x20other\x20fields\n\x20}\n\x20func\x20(obj\
    \x20*MyAwesomeAPIObject)\x20SetGroupVersionKind(gvk\x20*metav1.GroupVers\
    ionKind)\x20{\x20metav1.UpdateTypeMeta(obj,gvk)\x20};\x20GroupVersionKin\
    d()\x20*GroupVersionKind\n\n\x20TypeMeta\x20is\x20provided\x20here\x20fo\
    r\x20convenience.\x20You\x20may\x20use\x20it\x20directly\x20from\x20this\
    \x20package\x20or\x20define\n\x20your\x20own\x20with\x20the\x20same\x20f\
    ields.\n\n\x20+k8s:deepcopy-gen=false\n\x20+protobuf=true\n\x20+k8s:open\
    api-gen=true\n\n\n\n\x03\x04\x01\x01\x12\x03\\\x08\x10\n\x18\n\x04\x04\
    \x01\x02\0\x12\x03^\x02!\x1a\x0b\x20+optional\n\n\x0c\n\x05\x04\x01\x02\
    \0\x04\x12\x03^\x02\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03^\x0b\x11\n\
    \x0c\n\x05\x04\x01\x02\0\x01\x12\x03^\x12\x1c\n\x0c\n\x05\x04\x01\x02\0\
    \x03\x12\x03^\x1f\x20\n\x18\n\x04\x04\x01\x02\x01\x12\x03a\x02\x1b\x1a\
    \x0b\x20+optional\n\n\x0c\n\x05\x04\x01\x02\x01\x04\x12\x03a\x02\n\n\x0c\
    \n\x05\x04\x01\x02\x01\x05\x12\x03a\x0b\x11\n\x0c\n\x05\x04\x01\x02\x01\
    \x01\x12\x03a\x12\x16\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03a\x19\x1a\n\
    \xd8\x03\n\x02\x04\x02\x12\x04n\0}\x01\x1a\xcb\x03\x20Unknown\x20allows\
    \x20api\x20objects\x20with\x20unknown\x20types\x20to\x20be\x20passed-thr\
    ough.\x20This\x20can\x20be\x20used\n\x20to\x20deal\x20with\x20the\x20API\
    \x20objects\x20from\x20a\x20plug-in.\x20Unknown\x20objects\x20still\x20h\
    ave\x20functioning\n\x20TypeMeta\x20features--\x20kind,\x20version,\x20e\
    tc.\n\x20TODO:\x20Make\x20this\x20object\x20have\x20easy\x20access\x20to\
    \x20field\x20based\x20accessors\x20and\x20settors\x20for\n\x20metadata\
    \x20and\x20field\x20mutatation.\n\n\x20+k8s:deepcopy-gen=true\n\x20+k8s:\
    deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object\n\x20+pro\
    tobuf=true\n\x20+k8s:openapi-gen=true\n\n\n\n\x03\x04\x02\x01\x12\x03n\
    \x08\x0f\n\x0b\n\x04\x04\x02\x02\0\x12\x03o\x02!\n\x0c\n\x05\x04\x02\x02\
    \0\x04\x12\x03o\x02\n\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03o\x0b\x13\n\
    \x0c\n\x05\x04\x02\x02\0\x01\x12\x03o\x14\x1c\n\x0c\n\x05\x04\x02\x02\0\
    \x03\x12\x03o\x1f\x20\n\xc8\x01\n\x04\x04\x02\x02\x01\x12\x03t\x02\x19\
    \x1a\xba\x01\x20Raw\x20will\x20hold\x20the\x20complete\x20serialized\x20\
    object\x20which\x20couldn't\x20be\x20matched\n\x20with\x20a\x20registere\
    d\x20type.\x20Most\x20likely,\x20nothing\x20should\x20be\x20done\x20with\
    \x20this\n\x20except\x20for\x20passing\x20it\x20through\x20the\x20system\
    .\n\n\x0c\n\x05\x04\x02\x02\x01\x04\x12\x03t\x02\n\n\x0c\n\x05\x04\x02\
    \x02\x01\x05\x12\x03t\x0b\x10\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03t\
    \x11\x14\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03t\x17\x18\ne\n\x04\x04\
    \x02\x02\x02\x12\x03x\x02&\x1aX\x20ContentEncoding\x20is\x20encoding\x20\
    used\x20to\x20encode\x20'Raw'\x20data.\n\x20Unspecified\x20means\x20no\
    \x20encoding.\n\n\x0c\n\x05\x04\x02\x02\x02\x04\x12\x03x\x02\n\n\x0c\n\
    \x05\x04\x02\x02\x02\x05\x12\x03x\x0b\x11\n\x0c\n\x05\x04\x02\x02\x02\
    \x01\x12\x03x\x12!\n\x0c\n\x05\x04\x02\x02\x02\x03\x12\x03x$%\np\n\x04\
    \x04\x02\x02\x03\x12\x03|\x02\"\x1ac\x20ContentType\x20\x20is\x20seriali\
    zation\x20method\x20used\x20to\x20serialize\x20'Raw'.\n\x20Unspecified\
    \x20means\x20ContentTypeJSON.\n\n\x0c\n\x05\x04\x02\x02\x03\x04\x12\x03|\
    \x02\n\n\x0c\n\x05\x04\x02\x02\x03\x05\x12\x03|\x0b\x11\n\x0c\n\x05\x04\
    \x02\x02\x03\x01\x12\x03|\x12\x1d\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\
    \x03|\x20!\
";
